...
directory_name = "/Users/kathleen/Documents/PhD/2023-Project/Fig2"
...
include("model_scenario_GB2012_noBURST.jl")
...
if(SD=="yes")
        ...
        neurons_freq_noise[:,2:end] = rand(Uniform(0.1,1), size(neurons_freq_noise[:,2:end]))
        writedlm(@sprintf("%s/data/%s/neurons_freq_noise.dat", directory_name, experiment_name), neurons_freq_noise, header=false)
    #else
