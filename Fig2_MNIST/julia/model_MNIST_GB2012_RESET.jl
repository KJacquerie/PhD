...
function simulateTOY_ncellsScenarioNMOD(ncells::Int64,ncellsI::Int64,ncellsC::Int64,Istep_cell::Vector{Float64},gCAMPA::Matrix{Float64},  w_init::Matrix{Float64}, pixel_ON)
        ...
        # Postsynaptic excitatory cells | Layer 2
          ...
          for k=1:1:nPre
            ...
            # BURST
              ...
              # |
              # |
              # | REMOVE THE late phase PLASTICITY 
              # |
              # | 
