...
w_rand= load(sprintf('%s/%s/data/%s/tau=%d/w.dat', directory_name, Fig_num, experiment_name, tau_val));
w_STATE= load(sprintf('%s/%s/data/%s/tau=%d/w_BACK.dat', directory_name, Fig_num, experiment_name, tau_val));

l_rand= load(sprintf('%s/%s/data/%s/tau=%d/late_w.dat', directory_name, Fig_num, experiment_name, tau_val));
l_STATE= load(sprintf('%s/%s/data/%s/tau=%d/g_BACK.dat', directory_name, Fig_num, experiment_name, tau_val));
...
%%
Vbin = load(sprintf('%s/%s/data/%s/tau=%d/Vbin.dat',directory_name, Fig_num, experiment_name, tau_val));
Vspk = load(sprintf('%s/%s/data/%s/tau=%d/Vspk.dat',directory_name, Fig_num, experiment_name, tau_val));
LFP= load(sprintf('%s/%s/data/%s/tau=%d/LFP.dat',directory_name, Fig_num, experiment_name, tau_val));

%if(bound_type=="SB")
%    V1 = load(sprintf('%s/%s/data/%s/tau=%d/V1.dat',directory_name, Fig_num, experiment_name, tau_val));
%    V2 = load(sprintf('%s/%s/data/%s/tau=%d/V2.dat',directory_name, Fig_num, experiment_name, tau_val));
%    LFP= load(sprintf('%s/%s/data/%s/tau=%d/LFP.dat',directory_name, Fig_num, experiment_name, tau_val));
%end
%gion= load(sprintf('%s/%s/data/%s/tau=%d/gion.dat',directory_name, Fig_num, experiment_name, tau_val));
%gsyn= load(sprintf('%s/%s/data/%s/tau=%d/gsyn.dat',directory_name, Fig_num, experiment_name, tau_val));
...
print(sprintf('%s/%s/fig/tau=%d/%s_w',directory_name, Fig_num,tau_val, experiment_name), '-depsc', '-painters')
...
set(gcf, 'PaperUnits', 'centimeters');
set(gcf, 'PaperPosition', [0 0 ptx_long pty]);
print(sprintf('%s/%s/fig/tau=%d/%s_l',directory_name, Fig_num,tau_val,experiment_name), '-depsc', '-painters')


mm_MM = [mm MM]; 
csvwrite(sprintf('%s/%s/fig/tau=%d/l_mm_MM',directory_name, Fig_num, tau_val), mm_MM)
...
set(gcf, 'PaperUnits', 'centimeters');
set(gcf, 'PaperPosition', [0 0 ptx_long pty]);
print(sprintf('%s/%s/fig/tau=%d/%s_wl',directory_name, Fig_num,tau_val,experiment_name), '-depsc', '-painters')


mm_MM = [mm MM]; 
csvwrite(sprintf('%s/%s/fig/tau=%d/wl_mm_MM',directory_name, Fig_num, tau_val), mm_MM)
...
print(sprintf('%s/%s/fig/tau=%d/Raster_%s', directory_name, Fig_num, tau_val,experiment_name), '-depsc', '-painters')
...
print(sprintf('%s/%s/fig/tau=%d/LFP_%s', directory_name, Fig_num, tau_val, experiment_name), '-depsc')
...
print(sprintf('%s/%s/fig/tau=%d/SNR_%s', directory_name, Fig_num,tau_val, experiment_name), '-depsc')
