...
if(new_network==1 && fMax==50)
    ...
    writedlm(@sprintf("%s/data/%s/tau=%d/gion.dat",directory_name, experiment_name, tauG), g_cond, header=false)
else 
    gion = readdlm(@sprintf("%s/data/%s/tau=%d/gion.dat",directory_name, experiment_name, tauG))
...
if(new_network==1)
    ...
    writedlm(@sprintf("%s/data/%s/tau=%d/neurons_freq.dat", directory_name, experiment_name, tauG), neurons_freq, header=false)
else
    neurons_freq= readdlm(@sprintf("%s/data/%s/tau=%d/neurons_freq.dat",directory_name, experiment_name, tauG))
end
...
if(new_network==1 && fMax==50)
    ...
    writedlm(@sprintf("%s/data/%s/tau=%d/gsyn.dat",directory_name, experiment_name, tauG), g_syn, header=false)
else
    gsyn = readdlm(@sprintf("%s/data/%s/tau=%d/gsyn.dat",directory_name, experiment_name, tauG))
...
#writedlm(@sprintf("%s/data/%s/tau=%d/V.dat",directory_name, experiment_name, tauG), VV, header=false)
#writedlm(@sprintf("%s/data/%s/tau=%d/V1.dat",directory_name, experiment_name, tauG), V1, header=false)
#writedlm(@sprintf("%s/data/%s/tau=%d/V2.dat",directory_name, experiment_name, tauG), V2, header=false)

writedlm(@sprintf("%s/data/%s/tau=%d/Vspk.dat",directory_name, experiment_name, tauG), Vspk, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/Vbin.dat",directory_name, experiment_name, tauG), Vspk_bin, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/LFP.dat",directory_name, experiment_name, tauG), LFP_C_filt, header=false)

writedlm(@sprintf("%s/data/%s/tau=%d/w.dat",directory_name, experiment_name, tauG), ww, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/late_w.dat",directory_name, experiment_name, tauG), gCAMPA_plot, header=false)


writedlm(@sprintf("%s/data/%s/tau=%d/SPB_tonic.dat",directory_name, experiment_name, tauG), SPB_depol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/SPB_burst.dat",directory_name, experiment_name, tauG), SPB_hyperpol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/PER_tonic.dat",directory_name, experiment_name, tauG), PER_depol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/PER_burst.dat",directory_name, experiment_name, tauG), PER_hyperpol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/DC_tonic.dat",directory_name, experiment_name, tauG), DC_depol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/DC_burst.dat",directory_name, experiment_name, tauG), DC_hyperpol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/IBF_tonic.dat",directory_name, experiment_name, tauG), IBF_depol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/IBF_burst.dat",directory_name, experiment_name, tauG), IBF_hyperpol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/freq_tonic.dat",directory_name, experiment_name, tauG), freq_depol1, header=false)
writedlm(@sprintf("%s/data/%s/tau=%d/freq_burst.dat",directory_name, experiment_name, tauG), freq_hyperpol1, header=false)
