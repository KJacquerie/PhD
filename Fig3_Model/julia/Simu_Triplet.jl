...
if(region=="Cortex" && bound_type =="SB")
    const A2_m = 0.00826477 #7e-3
    const A3_m = 0.0        #2.3e-4 #0
    const A2_p = 0.0        #5e-10 #0
...
if(region=="Cortex" && bound_type =="HB")
