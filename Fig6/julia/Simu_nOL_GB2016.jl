...
for idx_state= 1:1:N_states #(*N_samples)
    ...
    #pattern_presented[idx]=rand(1:NB_patterns,1)[1]
        ...
        neurons_freq[idx_state, ncellsI+nPre+1+floor(Int64, (pattern_presented[idx_state]-1)/NB_patterns_classe)] = freq_post_ok 
