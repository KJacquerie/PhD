...
###
function simulateTOY_ncellsScenarioNMOD(ncells::Int64,ncellsI::Int64,ncellsC::Int64,Iapp_cell,gCAMPA::Matrix{Float64})
  # Initial conditions
  V=-60*ones(ncells)
  ...
  gCAMPA_var = gCAMPA
  w_BACK = zeros(length(ww_var), N_states)
  ...
  return  ww, Spkt, Spkt_binary, LFP_C
end
